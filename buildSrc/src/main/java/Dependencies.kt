object Versions {
    const val gradle_tools            = "3.3.0-alpha13"  // https://mvnrepository.com/artifact/com.android.tools.build/gradle

    // Android Arch                   
    const val arch_navigation         = "1.0.0-alpha06"  // https://mvnrepository.com/artifact/android.arch.navigation
    ...
    const val support_test_espresso   = "3.0.2-alpha1-1" // https://mvnrepository.com/artifact/com.android.support.test.espresso
    ...
    const val x_preference            = "1.0.0"          // https://mvnrepository.com/artifact/androidx.preference
    const val x_recyclerview          = "1.0.0"          // https://mvnrepository.com/artifact/androidx.recyclerview
    const val x_room                  = "2.0.0-rc01"     // https://mvnrepository.com/artifact/androidx.room
    const val x_test                  = "1.1.0-alpha4"   // https://mvnrepository.com/artifact/androidx.test
    const val x_test_espresso         = "3.1.0-alpha4"   // https://mvnrepository.com/artifact/androidx.test.espresso
    ...
    const val kotlin                  = "1.2.71"         // https://mvnrepository.com/artifact/org.jetbrains.kotlin
    ...
    // SquareUp
    const val squareup_okhttp         = "3.11.0"         // https://mvnrepository.com/artifact/com.squareup.okhttp3/okhttp
    const val squareup_retrofit       = "2.4.0"          // https://mvnrepository.com/artifact/com.squareup.retrofit2/retrofit

    // Others                         
    const val crashlytics             = "2.9.5"          // https://mvnrepository.com/artifact/com.crashlytics.sdk.android/crashlytics
